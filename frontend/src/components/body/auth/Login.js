  ...
  return (
    <>
      ...
      <div className="container_login">
        <img className="wave" src="https://images.pexels.com/photos/255379/pexels-photo-255379.jpeg"/>
        <div className="container">
          <div className="img">
            <Image src="https://easylearning.eu/wp-content/uploads/2020/11/LOGO-EASY_LEARNING_France.png" preview={false} />
          </div>
